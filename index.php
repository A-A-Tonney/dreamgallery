                ...
                <ul class="rslides" id="slider4">
                        ...
                        <div class="slider-img one-img">
                            <div class="container">
                                <div class="slider-info ">
                                    <h5>Pick The Best Photo For <br>Your Choice</h5>
                                    <div class="bottom-info">
                                        <p>History is a gallery of pictures in which there are few originals and many copies.
                                        Art washes away from the soul the dust of everyday life</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <li>
                        <div class="slider-img three-img">
                            <div class="container">
                                <div class="slider-info">
                                    <h5>Best Design and Painting<br> For Your Choice</h5>
                                    <div class="bottom-info">
                                        <p>Painting is self-discovery.
